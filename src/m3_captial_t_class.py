...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        hp1 = rg.Point(intersection_center.x - (width / 2), intersection_center.y - (letter_thickness / 2))

        hp2 = rg.Point(intersection_center.x + (width / 2), intersection_center.y + (letter_thickness / 2))

        vp1 = rg.Point(intersection_center.x - (letter_thickness / 2), intersection_center.y - (letter_thickness / 2))

        vp2 = rg.Point(intersection_center.x + (letter_thickness / 2),intersection_center.y + height - (letter_thickness / 2))
    ...
    def clone(self):
        ...
        newt = CapitalT(self.h_rect.get_center(), self.h_rect.get_width(),
